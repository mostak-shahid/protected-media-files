<?php
// hook into the init action and call mos_p_file_taxonomies when it fires
add_action( 'init', 'mos_p_file_taxonomies', 0 );

// create two taxonomies, categories and tags for the post type "p_file"
function mos_p_file_taxonomies() {
	...
	$args = array(
		...
		'query_var'         => true,
		'rewrite'           => array( 'slug' => 'p_file-category' ),
	);

	register_taxonomy( 'p_file-category', array( 'p_file' ), $args );
	...
	$args = array(
		...
		'query_var'             => true,
		'rewrite'               => array( 'slug' => 'p_file-tag' ),
	);

	register_taxonomy( 'p_file-tag', 'p_file', $args );
}